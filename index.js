...
const zigbeeSonoffSwitch               = (room, id) => `zigbee2mqtt/${room}~sonoff~switch~${id}`;
const zigbeeSonoffSwitchSet            = (room, id) => `zigbee2mqtt/${room}~sonoff~switch~${id}/set`;
